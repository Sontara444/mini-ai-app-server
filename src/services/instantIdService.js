...
const DEFAULT_PROMPT = `A super cute 3D animated toddler, large expressive eyes, soft smooth skin,
Pixar / DreamWorks animation style, high-detail facial features, warm soft lighting,
tiny nose, round cheeks, delicate eyelashes, playful smile,
...
async function generatePortrait(imageUrl, customPrompt = null) {
